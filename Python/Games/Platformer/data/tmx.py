...
# 
# Changes (April 2014 by Travis Morse):
# Ported to Python3
# Added sorting-by-y-coordinates to sprite layers
# Added map properties
# SpriteLayer drawing restricted to Sprite.rect area
...
class SpriteLayer(pygame.sprite.OrderedUpdates):
    def __init__(self, ordered=False):
        ...
        self.visible = True
        self.ordered = ordered #sort sprites by y-coordinate
